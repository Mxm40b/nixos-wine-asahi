...
build_time_vars = {'ABI3DLLLIBRARY': 'libpython3.dll',
 ...
 'BLDSHARED': 'aarch64-w64-mingw32-gcc -shared -Wl,--enable-auto-image-base '
 ...
 'CONFIG_ARGS': "'--prefix=/home/runner/work/llvm-mingw/llvm-mingw/install/llvm-mingw/python' "
                "'--build=x86_64-pc-linux-gnu' '--host=aarch64-w64-mingw32' "
                ...
                "'host_alias=aarch64-w64-mingw32' 'CC=aarch64-w64-mingw32-gcc'",
 ...
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/home/runner/work/llvm-mingw/llvm-mingw/cpython-mingw/build-aarch64-w64-mingw32/coverage.info',
 'COVERAGE_LCOV_OPTIONS': '--rc lcov_branch_coverage=1',
 'COVERAGE_REPORT': '/home/runner/work/llvm-mingw/llvm-mingw/cpython-mingw/build-aarch64-w64-mingw32/lcov-report',
 ...
 'IO_OBJS': '\\',
 'LDCXXSHARED': 'aarch64-w64-mingw32-g++ -shared -Wl,--enable-auto-image-base '
                '-L/home/runner/work/llvm-mingw/llvm-mingw/install/llvm-mingw/python/lib '
                '-Wl,-s',
 'LDFLAGS': '-L/home/runner/work/llvm-mingw/llvm-mingw/install/llvm-mingw/python/lib '
            '-Wl,-s',
 ...
 'LDLIBRARYDIR': '',
 'LDSHARED': 'aarch64-w64-mingw32-gcc -shared -Wl,--enable-auto-image-base '
             '-L/home/runner/work/llvm-mingw/llvm-mingw/install/llvm-mingw/python/lib '
             '-Wl,-s',
 'LDVERSION': '3.12',
 'LIBC': '',
 ...
 'LIBEXPAT_CFLAGS': '-I../Modules/expat -fno-strict-overflow -Wsign-compare '
                    ...
                    '-fvisibility=hidden -D_WIN32_WINNT=0x0602 '
                    '-DPY3_DLLNAME=\'L"libpython3.12.dll"\' '
                    '-DMS_DLL_ID=\'"3.12-arm64"\'  -I../Include/internal '
 ...
 'LIBHACL_CFLAGS': '-I../Modules/_hacl/include -D_BSD_SOURCE -D_DEFAULT_SOURCE '
                   ...
                   '-DPY3_DLLNAME=\'L"libpython3.12.dll"\' '
                   '-DMS_DLL_ID=\'"3.12-arm64"\'  -I../Include/internal '
                   '-IObjects -IInclude -IPython -I. -I../Include -I../PC  -I.',
 'LIBHACL_HEADERS': '\\',
 ...
 'LIBSUBDIRS': 'asyncio \\',
 'LINKCC': 'aarch64-w64-mingw32-gcc',
 ...
 'PYTHONPATH': '',
 'PYTHON_FOR_BUILD': '_PYTHON_PROJECT_BASE=/home/runner/work/llvm-mingw/llvm-mingw/cpython-mingw/build-aarch64-w64-mingw32 '
                     '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
                     'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
                     '/home/runner/work/llvm-mingw/llvm-mingw/cpython-mingw/build-aarch64-w64-mingw32/`cat '
                     'pybuilddir.txt`:)../Lib '
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': '_PYTHON_PROJECT_BASE=/home/runner/work/llvm-mingw/llvm-mingw/cpython-mingw/build-aarch64-w64-mingw32 '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
               '/home/runner/work/llvm-mingw/llvm-mingw/cpython-mingw/build-aarch64-w64-mingw32/`cat '
               'pybuilddir.txt`:)../Lib '
               ...
               '/home/runner/work/llvm-mingw/llvm-mingw/python-native/bin/python3',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': '_PYTHON_PROJECT_BASE=/home/runner/work/llvm-mingw/llvm-mingw/cpython-mingw/build-aarch64-w64-mingw32 '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=$(shell test -f pybuilddir.txt && echo '
               '/home/runner/work/llvm-mingw/llvm-mingw/cpython-mingw/build-aarch64-w64-mingw32/`cat '
               'pybuilddir.txt`:)../Lib '
 ...
 'abs_builddir': '/home/runner/work/llvm-mingw/llvm-mingw/cpython-mingw/build-aarch64-w64-mingw32',
 'abs_builddir_b2h': '/home/runner/work/llvm-mingw/llvm-mingw/cpython-mingw/build-aarch64-w64-mingw32',
